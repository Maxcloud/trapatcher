...
namespace MapleLib.WzLib
{
    ...
    public class WzImage : IWzObject, IPropertyContainer
	{
        ...
        public bool Changed
        {
            ...
            {
                changed = value;
                //Apperantly the game will crash if theres unrecognized values, I didn't think it would. But, thats why I removed the below -DeathRight
                //The below's original purpose was so TraPatchCreator could automatically select img's who had the Changed value as true (2) -DeathRight
