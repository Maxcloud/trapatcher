			...
			get
			{
				if (linkVal == null)
				{
					...
					foreach (string path in paths)
					{
                        ...
                        else if ((linkVal is WzImage) && ((WzImage)linkVal.Parent != null) && ((WzImage)linkVal.Parent)[path] != null)
                        {
                            linkVal = (IWzObject)((WzImage)linkVal.Parent)[path];
                        }
                        else if (((linkVal is WzDirectory) && ((WzDirectory)linkVal.Parent != null) && ((WzDirectory)linkVal.Parent)[path] != null))
                        {
                            linkVal = (IWzObject)((WzDirectory)linkVal.Parent)[path];
                        }
                        else
                        {
